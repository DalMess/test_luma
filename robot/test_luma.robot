...
Delete Items
    Remove Tags   xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li/div/div/div[3]/div/div/form/button/span
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[4]/div/div/div[2]/div/div/div[4]
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[4]/div/div/div[2]/div[2]/div/div
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[4]/div/div/div[3]/div/div/form/button/span
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[6]/div/div/div[3]/div/div/div[5]
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[6]/div/div/div[3]/div[2]/div/div
    Remove Tags    xpath=//main[@id='maincontent']/div[3]/div/div[4]/ol/li[6]/div/div/div[4]/div/div/form/button/span 
    Remove Tags    xpath=(.//*[normalize-space(text()) and normalize-space(.)='Toggle Nav'])[1]/following::a[2]
...
Delete All Articles
    ...
    FOR  ${element}    IN     @{article_elements}
        ${total_quantity}    Delete All Articles 
    
    END
    
    Log     Tous les articles ont été supprimés
    Should Be Empty    ${total_quantity}    0
